...
//}
	...
	public Clickable getVisaMethodField() {
		return Clickable.getElementBy(defaultVisaMethod,"Visa Method Field");
	}
	public Clickable getChangePlanMethodLink() {
	...
	public Editable getRewarsPointsField() {
