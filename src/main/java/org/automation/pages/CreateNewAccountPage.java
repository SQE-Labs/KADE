...
public class CreateNewAccountPage extends BasePage {
    ...
    By signInContinue = By.xpath("//div[@class='text-center mt-3 px-2 mb-3']/button[text()='Continue']");
    ...
    By finalSignInButton = By.xpath("(//button[@class='btn btn-primary'])[4]");
    By finalShowPassowrd = By.xpath("//span[text()='Show password']");
    ...
    public Clickable getSignInContinue() {
        return Clickable.getElementBy(signInContinue, "Sign In Button");
    }
    ...
    public Clickable getFinalSignInButton() {
        return Clickable.getElementBy(finalSignInButton, "Sign In Button");
    }
    public Clickable getFinalShowPassword() {
        return Clickable.getElementBy(finalShowPassowrd, "Show Password");
    }
