...
public class AdminPage extends BasePage {
    ...
    By filterIcon = By.cssSelector("a.collapsed i.fas.fa-filter.me-1");
    ...
    By statusTextBox = By.xpath("//textarea[contains(@class, \"form-control\")]\n");
    By updateStatusBtn = By.cssSelector("button[type=\"submit\"].btn-outline-primary\n");
    By deleteBtn = By.cssSelector("button[href=\".-deleteStore-\"]");
    By deleteStoreNameField = By.cssSelector("input[name=\"name\"][required]");
    By clickPermanentDeleteBtn = By.cssSelector("button[type=\"submit\"].btn-outline-danger.display-none\n");
    ...
    public Clickable getFilterIcon() {WebdriverWaits.waitForElementUntilVisible(filterIcon,100);return Clickable.getElementBy(filterIcon, "Filter Icon");}
    ...
    public Editable editStatusTextBox(){ WebdriverWaits.waitForElementUntilVisible(statusTextBox,1000); return Editable.getElementBy(statusTextBox);}
